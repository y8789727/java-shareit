...
public class ItemServiceImpl implements ItemService {
    ...
    public ItemDto create(int userId, ItemDto itemDto) {
        ...
        final Integer requestId = itemDto.getRequestId();
        if (requestId != null) {
            ItemRequest itemRequest = itemRequestRepository.findById(requestId).orElseThrow(() -> new NoSuchElementException("Не найден запрос с id=" + requestId));
